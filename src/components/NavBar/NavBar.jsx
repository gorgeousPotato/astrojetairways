...
export default function NavBar({ user, setUser }) {
  ...
  <nav className="NavBar navbar navbar-expand-lg bg-black rounded " aria-label="Thirteenth navbar example">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse d-lg-flex" id="navbarsExample11">
          <a class="navbar-brand col-lg-3 me-0 text-white" href="#">AstroJet</a>
